...
from courses.models import Payments, Сourse, Lesson
...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        ...
        payments_list = [
            {'user': User.objects.get(pk=3), 'date_payment': '2023-10-05', 'course': Сourse.objects.get(pk=2), 'amount': "150000", 'method': 'cash'},
            {'user': User.objects.get(pk=2), 'date_payment': '2022-08-05', 'course': Сourse.objects.get(pk=3), 'amount': "125000"},
